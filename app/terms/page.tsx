        ...
        <div className="md:col-span-9 space-y-20 max-w-3xl">
          <section id="beta-platform">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h2 className="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">1. Beta Platform</h2>
            </div>
          ...
          <section id="user-accounts">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h2 className="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">2. User Accounts</h2>
            </div>
          ...
          <section id="uploaded-materials">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h2 className="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">3. Uploaded Materials</h2>
            </div>
            <div className="space-y-4">
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-[17px]">
          ...
          <section id="ai-responses">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h2 className="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">4. AI-Generated Responses</h2>
            </div>
            <div className="space-y-4">
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-[17px]">
          ...
          <section id="acceptable-use">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h2 className="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">5. Acceptable Use</h2>
            </div>
            <div className="space-y-4">
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-[17px]">
                You agree not to:
          ...
          <section id="privacy">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h2 className="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">6. Privacy</h2>
            </div>
            <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-[17px]">
          ...
          <section id="availability">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h2 className="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">7. Availability and Responsibility</h2>
            </div>
            <div className="space-y-4">
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-[17px]">
          ...
          <section id="independent">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h2 className="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">8. Independent Platform and Grant Support</h2>
            </div>
            <div className="space-y-4">
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-[17px]">
          ...
          <section id="changes">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h2 className="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">9. Changes to These Terms</h2>
            </div>
            <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-[17px]">
          ...
          <section id="contact" className="p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm">
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">10. Contact</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/50">
                ...
                <div>
                  ...
                  <p className="text-slate-900 dark:text-white font-bold text-sm">parteek.bhatia@gmail.com</p>
                </div>
              </div>
            </div>
          </section>
